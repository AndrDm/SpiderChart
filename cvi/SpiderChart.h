...
#define  PANEL_CSA_CLASS                  15      /* control type: string, callback function: (none) */
#define  PANEL_LAG_CLASS                  16      /* control type: string, callback function: (none) */
#define  PANEL_SNRN_CLASS                 17      /* control type: string, callback function: (none) */
#define  PANEL_SMTR_CLASS                 18      /* control type: string, callback function: (none) */
#define  PANEL_CANVAS                     19      /* control type: canvas, callback function: scratch_pad */
#define  PANEL_SAVE_AS_BUTTON             20      /* control type: command, callback function: save_as_callback */
#define  PANEL_EXPORT_BUTTON              21      /* control type: command, callback function: export_callback */
#define  PANEL_LOAD_BUTTON                22      /* control type: command, callback function: load_callback */
#define  PANEL_ISOMTL_CLASS               23      /* control type: string, callback function: (none) */
